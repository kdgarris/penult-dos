...
const char EndGameNoGemScene[] = {
    ENDGAME_OPENING_SCENE,
    ENDGAME_BLAST_SCENE,
    ENDGAME_VOID_SCENE,
    ENDGAME_RESURRECTION_SCENE,
    ENDGAME_DUSKGROVE_SCENE,
    ENDGAME_KNIGHTING_SCENE,
    ENDGAME_KNIGHTING_SCENE
};

const char EndGameGemScene[] = {
    ENDGAME_OPENING_SCENE,
    ENDGAME_BLAST_SCENE,
    ENDGAME_VOID_SCENE,
    ENDGAME_HOME_SCENE,
...
const char EndGameNoGemText[] = {
    ENDGAME_OPENING_TEXT,
    ENDGAME_BLAST_TEXT,
    ENDGAME_VOID_TEXT,
    ENDGAME_RESURRECTION_TEXT,
    ENDGAME_DUSKGROVE_TEXT,
    ENDGAME_KNIGHTING_TEXT,
    ENDGAME_FINAL_TEXT
};

const char EndGameGemText[] = {
    ENDGAME_OPENING_TEXT,
    ENDGAME_BLAST_TEXT,
    ENDGAME_VOID_GEM_TEXT,
    ENDGAME_HOME_TEXT,
    ENDGAME_DUSKGROVE_TEXT,
    ENDGAME_KNIGHTING_TEXT,
    ENDGAME_FINAL_TEXT
...
const char NPCFunction[] = {
    ...
    ADVANCED_TRAINER_FUNCTION    // ROGUE_GOBLIN_ULA
};
...
const char *EndGameMessages[] = {
    "The light from your spell joins the darkness of the portal, causing an instant explosion. >>",
    "The explosion quickly grows, enveloping the entire room and its occupants. >>",
    "You wake up in the queen's throne room, restored by her magic. >>",
    "You and the dragon are teleported safely home. >>",
    "The city of Duskgrove has been liberated from Thana's forces. >>",
    "You are knighted for your service to Faradur. Rise up, %s %s of Faradur! >>",
    "Your mortal form expires in the blast, but your dragon saves your spirit from getting pulled into shadow. >>",
    "You apply your homing gem before your body is destroyed. >>",
    "Well done, Hero! Share your triumph: https://rb.gy/dkxvar"
};
...
const char *Messages[] = {
    ...
    "I am an outlaw that can survive this hellhole. I can teach you what I know.",
    "Rogue Goblin Ula Says:",
    ...
    "and trapped us here. You must penetrate her lair on the island to the east of this one.",
